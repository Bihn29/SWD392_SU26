...
const NAV_ITEMS = [
  { to: '/teacher/dashboard', icon: '📊', label: 'Tổng quan' },
  { to: '/teacher/courses', icon: '📚', label: 'Khóa học của tôi' },
  { to: '/teacher/profile', icon: '👤', label: 'Hồ sơ' },
];
    ...
    <div className="admin-layout">
      ...
      <aside className="sidebar">
        <div className="sidebar-logo">
          <span className="sidebar-logo-text">Giảng viên</span>
        </div>
        ...
        <nav className="sidebar-nav">
          ...
          {NAV_ITEMS.map(({ to, icon, label }) => (
            <NavLink
              ...
              id={`nav-teacher-${label.toLowerCase().replace(/\s/g, '-')}`}
            >
        ...
        <div className="sidebar-footer">
          <div className="sidebar-user">
            ...
            <div className="sidebar-user-info">
              <div className="sidebar-user-name">{user?.name || user?.fullName || 'Giảng viên'}</div>
      ...
      <div className="main-content">
        <header className="top-header">
          <div className="header-title">Trang Giảng Viên</div>
